...
#define CHARACTERISTIC_UUID_2 "cd52be79-023e-4ec9-8422-2f1cd70ec12f"
...
void loop() {
    ...
    if (deviceConnected) {
        ...
        Serial.print("pChar 2 getValue: ");
        Serial.println(rxValue.c_str());

        String txValue = "Random number from Seriver: " + String(random(1000));
        pCharacteristic_2->setValue(txValue.c_str());
        Serial.println("pChar 2 setValue: " + txValue);
