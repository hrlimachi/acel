...
static BLEAdvertisedDevice* myDevice;  //puntero para info del disp encontrado escaneando 
BLERemoteCharacteristic* pRemoteChar_1; //para acceder a la caracteristica 1 del servicio
...
void loop() {
  ...
  if (connected) {
    ...
    Serial.print("pChar 2 readValue: ");
    Serial.println(rxValue.c_str());
        String txValue = "Random value from client: " + String(-random(1000));
       Serial.println("pChar 2 writeValue: "  + txValue);
