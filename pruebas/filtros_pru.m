...
for i=1:cantidadArchivos
    ...
    filenamePru = sprintf('dataP%d', i); % 'data5';
    archivoImportar = fullfile(rutaArchivo, strcat(filename,'.mat'));
    load(archivoImportar);
    ...
    nombreDirectorioFiltro = fullfile(nombreDirectorio,filenamePru);
    ...
    rutaArchivoFiltro=fullfile(nombreDirectorioFiltro, strcat(filenamePru,'.png'));
...
%         [num, den] = tfdata(zTransfor, 'v');
        ...
        save(rutaArchivoFiltro,'yout','youtF','time');
 %   end
end
